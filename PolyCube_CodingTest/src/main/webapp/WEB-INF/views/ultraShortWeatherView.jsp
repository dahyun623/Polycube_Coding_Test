...
<head>
<meta charset="UTF-8">
<title>기상청 초단기 예보</title>
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
<script type="text/javascript" src="https://code.jquery.com/jquery-3.7.0.js"></script>
<script type="text/javascript" src="../js/ultraShortWeather.js"></script>
<style type="text/css">
	body {
		width:50%;
		height:auto;
...
<body>
	<div>
		...
		<input name="getUltraShortWeather" type="button" value="초단기예보 정보(JSON) 불러오기" class="btn btn-primary">
		<input name="saveUltraShortWeather" type="button" value="날씨 정보 저장하기" class="btn btn-success">
		<input name="savedUltraShortWeatherInfo" type="button" onclick="location.href='./ultraShortWeatherList.do'" value="저장된 정보 목록으로 이동" class="btn btn-info">
		<b>▼ 불러온 값</b>
		<div id="result"></div>
	</div>
</body>
